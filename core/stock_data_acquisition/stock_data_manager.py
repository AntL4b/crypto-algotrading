...
class StockDataManager(object):
    ...
    def __init__(self, data_list: List[StockDataDict] = None, auto_compute_indicators: bool = True):
        """
    ...
    def update_data(self, data_list: List[StockDataDict]) -> None:
        """
    ...
    def _update_data_line(self, data_list: List[StockDataDict]) -> None:
        """
